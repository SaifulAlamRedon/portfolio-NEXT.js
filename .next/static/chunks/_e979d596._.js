...
function AdminDashboardPage() {
    var _projects_data, _skills_data, _experiences_data, _education_data, _certificates_data, _pending_data, _pending_data1;
    _s();
    const projects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "admin",
            "projects"
        ],
        queryFn: {
            "AdminDashboardPage.useQuery[projects]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$project$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectService"].getAll()
        }["AdminDashboardPage.useQuery[projects]"]
    });
    const skills = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "admin",
            "skills"
        ],
    ...
    const experiences = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "admin",
            "experiences"
        ],
    ...
    const education = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "admin",
            "education"
        ],
    ...
    const certificates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "admin",
            "certificates"
        ],
    ...
    var _messages_data;
    const unreadMessages = ((_messages_data = messages.data) !== null && _messages_data !== void 0 ? _messages_data : []).filter((m)=>!m.isRead).length;
    var _projects_data1;
    const totalViews = ((_projects_data1 = projects.data) !== null && _projects_data1 !== void 0 ? _projects_data1 : []).reduce((sum, p)=>{
        var _p_viewCount;
        return sum + ((_p_viewCount = p.viewCount) !== null && _p_viewCount !== void 0 ? _p_viewCount : 0);
    }, 0);
    var _pending_data_length;
    const cards = [
        {
            label: "Projects",
            value: (_projects_data = projects.data) === null || _projects_data === void 0 ? void 0 : _projects_data.length,
        ...
        {
            label: "Skills",
            value: (_skills_data = skills.data) === null || _skills_data === void 0 ? void 0 : _skills_data.length,
        ...
        {
            label: "Experience",
            value: (_experiences_data = experiences.data) === null || _experiences_data === void 0 ? void 0 : _experiences_data.length,
        ...
        {
            label: "Education",
            value: (_education_data = education.data) === null || _education_data === void 0 ? void 0 : _education_data.length,
        ...
        {
            label: "Certificates",
            value: (_certificates_data = certificates.data) === null || _certificates_data === void 0 ? void 0 : _certificates_data.length,
        ...
        },
        {
            ...
            value: (_pending_data = pending.data) === null || _pending_data === void 0 ? void 0 : _pending_data.length,
            ...
            highlight: ((_pending_data_length = (_pending_data1 = pending.data) === null || _pending_data1 === void 0 ? void 0 : _pending_data1.length) !== null && _pending_data_length !== void 0 ? _pending_data_length : 0) > 0
        },
        {
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex h-10 w-10 items-center justify-center rounded-xl ".concat(card.highlight ? "bg-amber-500/10 text-amber-500" : "bg-primary/10 text-primary"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    card.loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                        ...
                                        children: (_card_value = card.value) !== null && _card_value !== void 0 ? _card_value : 0
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/(dashboard)/page.tsx",
                                        lineNumber: 74,
                                        columnNumber: 19
...
_s(AdminDashboardPage, "MhNN3G8V9UkfYjtXfgT0RfGha3A=", false, function() {
    return [
...
//# sourceMappingURL=_e979d596._.js.map