...
"[project]/src/app/admin/(dashboard)/certificates/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function CertificateForm(param) {
    let { cert, onDone } = param;
    var _cert_issueDate;
    _s();
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])();
    var _cert_title, _cert_issuer, _cert_issueDate_slice, _cert_credentialUrl, _cert_image;
    const { register, handleSubmit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        defaultValues: {
            title: (_cert_title = cert === null || cert === void 0 ? void 0 : cert.title) !== null && _cert_title !== void 0 ? _cert_title : "",
            issuer: (_cert_issuer = cert === null || cert === void 0 ? void 0 : cert.issuer) !== null && _cert_issuer !== void 0 ? _cert_issuer : "",
            issueDate: (_cert_issueDate_slice = cert === null || cert === void 0 ? void 0 : (_cert_issueDate = cert.issueDate) === null || _cert_issueDate === void 0 ? void 0 : _cert_issueDate.slice(0, 10)) !== null && _cert_issueDate_slice !== void 0 ? _cert_issueDate_slice : "",
            credentialUrl: (_cert_credentialUrl = cert === null || cert === void 0 ? void 0 : cert.credentialUrl) !== null && _cert_credentialUrl !== void 0 ? _cert_credentialUrl : "",
            image: (_cert_image = cert === null || cert === void 0 ? void 0 : cert.image) !== null && _cert_image !== void 0 ? _cert_image : ""
        }
    });
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "CertificateForm.useMutation[mutation]": (data)=>cert ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$certificate$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["certificateService"].update(cert.id, data) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$certificate$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["certificateService"].create(data)
        }["CertificateForm.useMutation[mutation]"],
        onSuccess: {
            "CertificateForm.useMutation[mutation]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(cert ? "Certificate updated" : "Certificate added");
        ...
        onError: {
            "CertificateForm.useMutation[mutation]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Something went wrong")
        }["CertificateForm.useMutation[mutation]"]
    });
...
_s(CertificateForm, "ul7LIbeugKsAtpcOz7Xe3WRsQk8=", false, function() {
    return [
...
function AdminCertificatesPage() {
    ...
    const removeMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "AdminCertificatesPage.useMutation[removeMutation]": (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$certificate$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["certificateService"].remove(id)
        }["AdminCertificatesPage.useMutation[removeMutation]"],
        onSuccess: {
            "AdminCertificatesPage.useMutation[removeMutation]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Certificate deleted");
                queryClient.invalidateQueries({
                    queryKey: [
                        "admin",
                        "certificates"
        ...
        onError: {
            "AdminCertificatesPage.useMutation[removeMutation]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete")
        }["AdminCertificatesPage.useMutation[removeMutation]"]
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            showNew && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mb-4",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CertificateForm, {
            ...
            isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                lineNumber: 114,
                columnNumber: 9
            }, this) : !(certificates === null || certificates === void 0 ? void 0 : certificates.length) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: certificates.map((cert)=>{
                    var _cert_issueDate;
                    return editingId === cert.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CertificateForm, {
                        cert: cert,
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            cert.issuer,
                                            " · ",
                                            (_cert_issueDate = cert.issueDate) === null || _cert_issueDate === void 0 ? void 0 : _cert_issueDate.slice(0, 10)
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/admin/(dashboard)/certificates/page.tsx",
                                        lineNumber: 133,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        size: "sm",
                                        onClick: ()=>{
                                            if (window.confirm('Delete "'.concat(cert.title, '"?'))) removeMutation.mutate(cert.id);
                                        },
...
_s1(AdminCertificatesPage, "Njd9yrplLSih+JaysyynlrdAAts=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
...
_c1 = AdminCertificatesPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "CertificateForm");
__turbopack_context__.k.register(_c1, "AdminCertificatesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_91d05881._.js.map