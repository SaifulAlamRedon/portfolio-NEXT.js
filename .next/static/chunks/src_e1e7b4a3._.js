...
const analyticsService = {
    async trackVisitor () {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].ANALYTICS_VISITOR, {
                event: "visit",
                source: typeof document !== "undefined" ? document.referrer || "direct" : "direct",
                userId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVisitorId"])()
            });
        } catch (e) {
    ...
    async trackPageView (pageUrl) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].ANALYTICS_PAGE_VIEW, {
                event: "page_view",
                source: pageUrl,
                userId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVisitorId"])()
            });
    ...
    async getTotalVisitors () {
        ...
        const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unwrap"])(res.data);
        var _data_totalVisitors;
        return (_data_totalVisitors = data === null || data === void 0 ? void 0 : data.totalVisitors) !== null && _data_totalVisitors !== void 0 ? _data_totalVisitors : 0;
    },
...
"[project]/src/features/projects/project-detail.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProjectDetail(param) {
    ...
    var _project_images;
    _s();
    const { data: project, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProject"])(slug);
    const { data: allProjects } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProjects"])();
    const related = (allProjects !== null && allProjects !== void 0 ? allProjects : []).filter((p)=>p.slug !== slug && p.status === "published").filter((p)=>{
        var _p_category;
        var _project_technologies;
        return (project === null || project === void 0 ? void 0 : project.category) && project.category.name === ((_p_category = p.category) === null || _p_category === void 0 ? void 0 : _p_category.name) || ((_project_technologies = project === null || project === void 0 ? void 0 : project.technologies) !== null && _project_technologies !== void 0 ? _project_technologies : []).some((t)=>{
            var _p_technologies;
            return ((_p_technologies = p.technologies) !== null && _p_technologies !== void 0 ? _p_technologies : []).some((pt)=>pt.name === t.name);
        });
    }).slice(0, 3);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectDetail.useEffect": ()=>{
            if (project === null || project === void 0 ? void 0 : project.id) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$analytics$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyticsService"].trackProjectView(project.id);
            }
        }
    }["ProjectDetail.useEffect"], [
    ...
    const handleShare = async ()=>{
        var _project_title;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shareProject"])((_project_title = project === null || project === void 0 ? void 0 : project.title) !== null && _project_title !== void 0 ? _project_title : "Project", window.location.href);
    ...
    const sections = [
        {
            key: "overview",
            label: "Overview",
            content: (_ref = (_project_description = project.description) !== null && _project_description !== void 0 ? _project_description : project.shortDescription) !== null && _ref !== void 0 ? _ref : ""
        }
    ].filter((s)=>s.content);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            children: [
                                                ...
                                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(project.createdAt)
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/features/projects/project-detail.tsx",
                                            lineNumber: 138,
            ...
            ((_project_images = project.images) === null || _project_images === void 0 ? void 0 : _project_images.some(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNextImageSource"])) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$animations$2f$fade$2d$in$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FadeIn"], {
                className: "mt-10",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
...
_s(ProjectDetail, "gkXGdXlVv03FaivUa8f2heNSckc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProject"],
...
//# sourceMappingURL=src_e1e7b4a3._.js.map