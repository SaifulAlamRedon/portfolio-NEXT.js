...
function AdminLoginPage() {
    ...
    const setUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "AdminLoginPage.useAuthStore[setUser]": (s)=>s.setUser
    }["AdminLoginPage.useAuthStore[setUser]"]);
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login(data);
            setUser(res.user);
            ...
            const message = (_response_data_message = (_this = err) === null || _this === void 0 ? void 0 : (_response = _this.response) === null || _response === void 0 ? void 0 : (_response_data = _response.data) === null || _response_data === void 0 ? void 0 : _response_data.message) !== null && _response_data_message !== void 0 ? _response_data_message : "Invalid email or password";
...
_s(AdminLoginPage, "ga/zFwxE3vFRKf4PKbpBm+bqt2w=", false, function() {
    return [
...
//# sourceMappingURL=src_5f889eba._.js.map